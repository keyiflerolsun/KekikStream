...
class SuperFilmIzle(PluginBase):
    ...
    main_page   = {
        ...
        f"{main_url}/dizi-kategori/animasyon-dizileri/page/" : "Animasyon Dizileri",
        f"{main_url}/dizi-kategori/cizgi-ve-dizi/page/"      : "Çizgi ve Dizi",
        f"{main_url}/dizi-kategori/dram-dizileri/page/"      : "Dram Dizileri",
        f"{main_url}/dizi-kategori/fantastik-diziler/page/"  : "Fantastik Diziler",
        f"{main_url}/dizi-kategori/gelecek-diziler/page/"    : "Gelecek Diziler",
        f"{main_url}/dizi-kategori/komedi-dizileri/page/"    : "Komedi Dizileri",
        f"{main_url}/dizi-kategori/romantik-dizileri/page/"  : "Romantik Dizileri",
        f"{main_url}/dizi-kategori/yerli-dizileri/page/"     : "Yerli Dizileri",
    }
