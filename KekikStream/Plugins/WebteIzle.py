...
class WebteIzle(PluginBase):
    ...
    main_page   = {
        ...
        f"{main_url}/filtre?tur=Aile"        : "Aile",
        ...
        f"{main_url}/filtre?tur=Stand-Up"    : "Stand-Up",
        f"{main_url}/filtre?tur=Spor"        : "Spor",
        f"{main_url}/filtre?tur=Tarihi"      : "Tarihi",
        f"{main_url}/filtre?tur=Western"     : "Western",
    }
