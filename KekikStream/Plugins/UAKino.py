...
class UAKino(PluginBase):
    ...
    main_page = {
        ...
        f"{main_url}/filmy/documentaries/page/"          : "Документальні",
        f"{main_url}/filmy/natives/page/"                : "Українські",
        f"{main_url}/filmy/genre-action/page/"           : "Бойовики",
        f"{main_url}/filmy/genre_melodrama/page/"        : "Мелодрами",
        ...
        f"{main_url}/filmy/genre_science_fictions/page/" : "Наукова фантастика",
        ...
        f"{main_url}/seriesss/fantastic_series/page/"    : "Фантастичнi серiали",
        f"{main_url}/seriesss/detective_series/page/"    : "Детективнi серiали",
        f"{main_url}/seriesss/drama_series/page/"        : "Драматичнi серiали",
        f"{main_url}/seriesss/thriller_series/page/"     : "Трилери (серiали)",
        f"{main_url}/seriesss/historical_series/page/"   : "Історичнi (серiали)",
        f"{main_url}/seriesss/turecki-serialy/page/"     : "Турецькi серiали",
        ...
        f"{main_url}/animeukr/anime-series/page/"        : "Аніме серіали",
        f"{main_url}/animeukr/anime-solo/page/"          : "Аніме фільми",
    }
