...
class PlayabilityHelper:
    ...
    def _get_cf(cls):
        ...
        if cls._cf_session is None:
            cls._cf_session = AsyncSession(impersonate="firefox", timeout=3.0)
    ...
    async def is_url_playable(cls, link: ExtractResult) -> tuple[bool, str]:
        ...
        return True, "Bu fonksiyon şu anda devre dışı bırakıldı. Oynatılabilirlik kontrolü geçici olarak kapatıldı."
